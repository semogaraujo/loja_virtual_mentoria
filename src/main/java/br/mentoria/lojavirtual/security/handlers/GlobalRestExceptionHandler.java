...
public class GlobalRestExceptionHandler {
    ...
    public void handleAuth(AuthenticationException ex,
                           HttpServletRequest req,
                           HttpServletResponse res) throws IOException {
    ...
    public void handleDenied(AccessDeniedException ex,
                             HttpServletRequest req,
                             HttpServletResponse res) throws IOException {
    ...
    public void handleResourceNotFound(ResourceNotFoundException ex, HttpServletRequest req, HttpServletResponse res) throws IOException {
