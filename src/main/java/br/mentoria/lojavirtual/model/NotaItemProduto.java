...
public class NotaItemProduto implements Serializable {
	...
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "nota_fical_compra_fk"))
	private NotaFiscalCompra notaFiscalCompra;

	@ManyToOne
	@JoinColumn(name = "produto_id", nullable = false, 
	foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "nota_item_produto_produto_fk"))
